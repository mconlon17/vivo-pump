...
results -- columns such as notes or remove.  Begin work on closures -- aditional column defs that provide
alternate paths to entities.  Executing the closures allow us to reuse the columns and create "triangular"
